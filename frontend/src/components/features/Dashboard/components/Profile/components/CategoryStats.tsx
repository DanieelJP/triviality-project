...
const CategoryStats: React.FC<CategoryStatsProps> = ({ stats }) => {
    ...
    return (
        <div className="category-stats">
            <h3>{intl.formatMessage({ id: 'profile.stats.categoryPerformance', defaultMessage: 'Performance by Category' })}</h3>
                ...
                <ResponsiveContainer width="100%" height={300}>
                    ...
                    >
                        ...
                        <XAxis
                            ...
                            interval={0}
                            label={{
                                value: intl.formatMessage({ id: 'profile.stats.categories', defaultMessage: 'Categories' }),
